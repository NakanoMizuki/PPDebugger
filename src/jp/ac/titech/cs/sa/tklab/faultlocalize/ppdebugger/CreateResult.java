...
public class CreateResult implements Callable<Result>{
	...
	public CreateResult(PassedModel passedModel,File failedFile,StatementDataFactory factory,int hopNum) {
	...
	public Result call() throws Exception {
		ExecutionModel em = new Creator(factory).createExecutionModel(failedFile,hopNum);
